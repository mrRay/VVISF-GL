/*
{
    ...
    "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/XsjXRm by nimitz.  My first attempt at recreating a real world object.  I tried making the sphere glow based on ray position but it didn't look better and was much more expensive.\n\nMouse drag to rotate.",
    "IMPORTED": {
        "iChannel0": {
            "NAME": "iChannel0",
