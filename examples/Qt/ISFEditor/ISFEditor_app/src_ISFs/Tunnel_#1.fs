/*
{
    ...
    "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/4dfGDr by WAHa_06x36.  A distancefield tunnel with a palette stolen from a spectrum analyzer.",
    "IMPORTED": {
    },
    "INPUTS": [
    ]
...
void main() {
	...
	vec2 coords=(2.0*gl_FragCoord.xy-RENDERSIZE.xy)/max(RENDERSIZE.x,RENDERSIZE.y);
