/*
{
    ...
    "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/MdfBRX by BigWIngs.  See comment block for details. Use mouse to scrub time. Hope you like it!\n\nVideo of the effect:\nhttps://www.youtube.com/watch?v=WrxZ4AZPdOQ\n\nMaking of tutorial:\nhttps://www.youtube.com/watch?v=eKtsY7hYTPg",
    "IMPORTED": {
    },
    "INPUTS": [
        {
