...
- (void) awakeFromNib	{
	if (!alreadyAwake)	{
		[tableView registerForDraggedTypes:@[@"com.Vidvox.ISFEditor.JSONGUIPboard"]];
	}
...
- (IBAction) saveCurrentValsAsDefaults:(id)sender	{
	...
	for (auto const & attr : attrs)	{
		...
		case ISFValType_Bool:
			[input setObject:[NSNumber numberWithBool:attribVal.getBoolVal()] forKey:@"DEFAULT"];
			break;
		case ISFValType_Long:
			[input setObject:[NSNumber numberWithLong:attribVal.getLongVal()] forKey:@"DEFAULT"];
			break;
		case ISFValType_Float:
			[input setObject:[NSNumber numberWithFloat:attribVal.getDoubleVal()] forKey:@"DEFAULT"];
			break;
		case ISFValType_Point2D:
			[input setObject:@[[NSNumber numberWithFloat:attribVal.getPointValByIndex(0)], [NSNumber numberWithFloat:attribVal.getPointValByIndex(1)]] forKey:@"DEFAULT"];
			break;
		case ISFValType_Color:
			[input setObject:@[[NSNumber numberWithFloat:attribVal.getColorValByChannel(0)], [NSNumber numberWithFloat:attribVal.getColorValByChannel(1)], [NSNumber numberWithFloat:attribVal.getColorValByChannel(2)], [NSNumber numberWithFloat:attribVal.getColorValByChannel(3)]] forKey:@"DEFAULT"];
			break;
		}
	}
	//	save everything!
