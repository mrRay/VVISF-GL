...
#pragma clang diagnostic ignored "-Woverloaded-virtual"
		...
		*/
		virtual GLBufferRef createAndRenderABuffer(const VVGL::Size & inSize=VVGL::Size(640.,480.), map<int32_t,GLBufferRef> * outPassDict=nullptr, const GLBufferPoolRef & inPoolRef=nullptr);
		//virtual GLBufferRef createAndRenderABuffer(const VVGL::Size & inSize, const double & inRenderTime, const GLBufferPoolRef & inPoolRef=nullptr);
		/*!
		\brief Creates a buffer of the appropriate type (defaults to 8 bits per channel unless the ISF explicitly requires a floating point texture) and renders into it.
		\param inSize The size of the frame you want to render.
		...
		\param inPoolRef The buffer pool to use to create GL resources for this frame (defaults to the global buffer pool).
		*/
		virtual GLBufferRef createAndRenderABuffer(const VVGL::Size & inSize, const double & inRenderTime, map<int32_t,GLBufferRef> * outPassDict=nullptr, const GLBufferPoolRef & inPoolRef=nullptr);
